...
public class Tests {
    ...
    public void test_1() {
        ...
        List<String> list_1 = integerList.stream().map(item -> item.toString()).toList();
    }
    ...
    public void test_3() {
        ...
        stringList.stream().map(item -> "Number - " + item).toList().stream().
    ...
    public void test_4() {
        ...
        map.entrySet().stream().filter((item -> item.getKey() > 3 && item.getKey() <9)).toList();
    }
    ...
    public void test_5() {
        Map<Integer, String> map = getMap();
        List list_1 = new ArrayList(getMap().entrySet());
    ...
    public void test_6() {
        ...
        elements.stream().filter(item -> item.getValue() == null).
                peek(item -> item.setDisplayed(true)).toList();
    }
    ...
    public void test_7() {
        List<WebElement> elements = getElements();
        elements.stream().peek(item -> item.setDisplayed(!item.isDisplayed())).toList();
        //elements.stream().sorted(Comparator.comparing(WebElement::getType).;
    }
    ...
    public void test_8() {
        List<WebElement> elements = getElements();
//        elements.stream().collect(Collectors.toMap(item-> item.getText(), item->item.getType())).
